...
.js" integrity="sha384ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
</head>

<body style="background-image: url(https://fondosmil.com/fondo/17009.jpg);">
    <form action="EjercicioIF.php" method="POST">
        <div class="container">
            <div class="row align-items-start">
                ...
                <div class="col">
                    <br>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="formlabel">Ingrese la cantidad total</label>
                        <input type="number" step="0.01" min="1.00" class="formcontrol" id="exampleFormControlInput1" placeholder="1.00" name="txtDinero">
                        <br>
                        <center>
            ...
            <br><br> <?php if (isset($_POST["btn_Calcular"])) {
